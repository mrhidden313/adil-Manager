        ...
        <div class="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div class="space-y-3">
            ...
            {#if selectedTicket.genericData?.phone}
              <div>
                <span class="block text-[10px] uppercase text-slate-400 font-bold mb-0.5">Phone</span>
                <span class="text-indigo-700 font-bold">{selectedTicket.genericData.phone}</span>
              </div>
            {/if}

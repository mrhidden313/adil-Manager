    ...
    <div class="flex-1 overflow-y-auto p-4 md:p-8 bg-transparent">
      <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 animate-stagger" style="animation-delay: 200ms;">
          ...
          <!-- Paid Bonus -->
          <div class="p-5 rounded-2xl relative overflow-hidden flex flex-col justify-between group hover:scale-[1.02] transition-transform duration-300" style="background: linear-gradient(135deg, rgba(99,102,241,0.15), rgba(139,92,246,0.12)); border: 1px solid rgba(99,102,241,0.25); box-shadow: 0 4px 20px rgba(99,102,241,0.08); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);">

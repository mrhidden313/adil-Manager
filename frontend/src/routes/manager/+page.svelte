          ...
          <div class="mb-5 bg-white border border-slate-200 p-4 rounded-xl shadow-sm">
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div class="col-span-2 mt-1">
                <span class="block text-[10px] uppercase text-slate-400 font-bold mb-2">Customer WhatsApp</span>
                <a href={`https://wa.me/${selectedTicket.genericData.phone.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" class="inline-flex items-center space-x-2 bg-emerald-100 hover:bg-emerald-200 text-emerald-700 font-bold px-4 py-2 rounded-xl transition-colors text-sm">

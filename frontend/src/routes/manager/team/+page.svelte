  ...
  <aside class="w-72 liquid-sidebar text-slate-300 flex-col hidden md:flex shadow-2xl z-10 shrink-0">
    ...
    <div class="flex-1 py-6 px-3 flex flex-col justify-between overflow-y-auto">
      <div class="space-y-1.5">
        <div class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 px-3">Agency Operations</div>
        <button use:ripple class="w-full flex items-center space-x-3 liquid-glass-btn text-slate-300 px-3.5 py-2.5 rounded-xl font-medium" onclick={() => window.location.href='/manager'}>
      ...
      <!-- Live Logs Terminal in Manager Staff Management Sidebar -->
      <LiveLogsTerminal />
    </div>
  </aside>
